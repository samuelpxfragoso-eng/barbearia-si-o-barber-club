      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <h3 className="text-4xl md:text-6xl font-black uppercase tracking-tighter leading-tight mb-8">
            ONDE A <span className="text-gold">TRADIÇÃO</span> ENCONTRA <br /> O ESTILO.
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {units.map((unit, index) => (
            <div 
              key={index} 
              className="group p-8 md:p-10 rounded-[32px] bg-white/[0.02] border border-white/5 backdrop-blur-sm transition-all hover:border-gold/20 flex flex-col min-h-[380px]"
            >
